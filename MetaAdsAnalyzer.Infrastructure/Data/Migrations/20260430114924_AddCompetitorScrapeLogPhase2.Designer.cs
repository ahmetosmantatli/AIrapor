...
namespace MetaAdsAnalyzer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260430114924_AddCompetitorScrapeLogPhase2")]
    partial class AddCompetitorScrapeLogPhase2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetaAdsAnalyzer.Core.Entities.CompetitorAd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("DeliveryStartTime")
                        .HasPrecision(3)
                        .HasColumnType("timestamp(3) with time zone");

                    b.Property<DateTimeOffset?>("DeliveryStopTime")
                        .HasPrecision(3)
                        .HasColumnType("timestamp(3) with time zone");
                    ...
                    b.Property<string>("MetaAdArchiveId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<string>("PublisherPlatforms")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TrackedCompetitorId", "IsActive");

                    b.HasIndex("TrackedCompetitorId", "LastSeenAt");

                    b.HasIndex("TrackedCompetitorId", "MetaAdArchiveId")
                        .IsUnique();
            ...
            modelBuilder.Entity("MetaAdsAnalyzer.Core.Entities.TrackedCompetitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MetaAdsAnalyzer.Core.Entities.UserSyncLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
